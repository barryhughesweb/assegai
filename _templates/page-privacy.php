...
<section class="section--whole privacy">
    <main>
        <div class="container--xlarge">
           <div class="padding_box">
            <div class="grid">
              ...
              <?php /*
               <p><strong>[Company Name Ltd]</strong> is committed to protecting your privacy. We value our visitors and endeavour to create an enjoyable and safe shopping experience when visiting our website.</p>
        <p><strong>[Company Name Ltd]</strong> is a trading name of <strong>[Company Name Ltd]</strong>. Reg no: <strong>[1234567]</strong>, Registered in England &amp; Wales.</p>
        ...
        <ul>
          ...
          <li>
            ...
            <p>We will take reasonable technical and organisational precautions to prevent the loss, misuse or alteration of your personal information. We will never store your credit/debit card information on our website. All electronic transactions you make to or receive from us will be encrypted using SSL technology via <strong>[SSL Certificate Brand]</strong> and will be transferred and processed by <strong>[Payment Gateway]</strong>. Of course, data transmission over the internet is inherently insecure, and we cannot guarantee the security of data sent over the internet. You are responsible for keeping your password and user details confidential. We will not ask you for your password.</p>
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <h3>Enquiry Forms</h3>
            <p>Our website's visitors can choose to contact us via form(s) on our website. In order to prevent spam enquiries, we protect our forms with anti-spam challenges which ensure the visitor is an actual living person, rather than a computer bot or spider.</p>
          </li>
        </ul>
        ...
        <div id="table">
          <div class="table--full">
            <div class="table__item--row">
              <div class="colour">
                <div class="table--full">
                  <div class="table__item--quarter">
                    <div class="content">
                      Cookie Category
                    </div>
                  </div><div class="table__item--quarter">
                    <div class="content">
                      Cookie Name
                    </div>
                  </div><div class="table__item--two__quarters">
                    <div class="content">
                      Cookie Description
                    </div>
                  </div>
            ...
            --><div class="table__item--row">
              <div class="colour">
                <div class="table--full">
                  ...
                  <div class="table__item--two__quarters">
                    <div class="content">
                      This cookie is set by our website once you have seen and acknowledged our Cookie banner. This cookie will expire and automatically delete itself after<strong> [14] </strong>days.
                    </div>
                  </div>
                </div>
              </div>
            ...
            --><div class="table__item--row">
              <div class="colour">
                <div class="table--full">
                  ...
                  <div class="table__item--quarter empty"></div><div class="table__item--quarter">
                    <div class="content">
                      _utmb
                    </div>
                  </div>
            ...
            --><div class="table__item--row">
              <div class="colour">
                <div class="table--full">
                  ...
                  <div class="table__item--quarter empty"></div><div class="table__item--quarter">
                    <div class="content">
                      wordpress_test_cookiewordpress_wordpress_logged_in
                    </div>
                  </div>
                  <div class="table__item--two__quarters">
                    <div class="content">
                  ...
                  <div class="table__item--quarter empty"></div><div class="table__item--quarter">
                    <div class="content">
                      comment_authorcomment_author_emailcomment_author_url
                    </div>
                  </div>
                  <div class="table__item--two__quarters">
                    <div class="content">
        ...
        <p>If you are concerned about cookies tracking your movements on the Internet then you may be concerned about spyware. Spyware is the name given to a particular band of cookies that track personal information about you. There are many antispyware programs that you can use to prevent this from happening. Learn more about antispyware software - <a title="Spyware" href="http://en.wikipedia.org/wiki/Spyware" target="_blank">http://en.wikipedia.org/wiki/Spyware. </a>You call also disable Google Analytics on all websites <a title="Disable Google Analytics" href="https://tools.google.com/dlpage/gaoptout" target="_blank"></a>by downloading the <a href="https://tools.google.com/dlpage/gaoptout" target="_blank">Google Analytics Opt-out Browser Add-on</a>.</p> */ ?>
