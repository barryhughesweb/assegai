...
if ( ! function_exists( 'hobbes_full_schema' ) ) :

function hobbes_full_schema() {
...
<div class="grid--wide">
    <div class="grid__item--half--lap__whole widget">
      ...
      <?php if ( $options['company_number'] != '' ) { 

        echo '<p>Company No. '. $options['company_number'] .'</p>';
    ...
    <?php if ( $options['mobile_number'] != '' ) { ?>
      ...
      <p>Mobile: <a href="tel:<?php echo $mob_meta; ?>" onclick="ga('send', 'event', 'link', 'click', 'Contact Sidebar Mobile Number');"><?php echo $mob_number; ?></a></p>
        <?php } ?>
    </div><!--
